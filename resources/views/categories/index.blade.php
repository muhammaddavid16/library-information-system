        ...
        <div class="col">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <a href="{{ route('categories.create') }}" class="btn btn-primary" title="Tambah data">
                        ...
                        <tbody>
                            @forelse ($categories as $category)
                                <tr>
                                    ...
                                    <td style="width: 65%;" class="text-wrap">{{ $category->description ?? '-' }}</td>
                                    <td style="width: 5%">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right p-1" role="menu">
                                                <a href="{{ route('categories.edit', $category->id) }}" class="dropdown-item rounded">
                                                    <i class="fas fa-edit mr-2"></i>
                                                    Edit
                                                </a>
                                                <button type="button" class="dropdown-item rounded text-danger" data-toggle="modal" data-target="#deleteModal" data-id="{{ $category->id }}" data-name="{{ $category->name }}">
