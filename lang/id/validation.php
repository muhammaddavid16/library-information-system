...
return [
    ...
    | aturan ukuran. Anda dapat mengubah setiap pesan ini sesuai kebutuhan.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Di sini, Anda dapat menentukan pesan-pesan validasi khusus untuk atribut menggunakan
    | konvensi "attribute.rule" untuk memberi nama baris-baris bahasa tersebut. Ini membuatnya cepat untuk
    ...
    */
    ...
    | dengan sesuatu yang lebih mudah dimengerti oleh pembaca seperti "Alamat Email" daripada "email".
